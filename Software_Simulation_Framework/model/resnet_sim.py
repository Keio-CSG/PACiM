...
def resnet18_sim(**kwargs):
    model = ResNet(BasicBlock, [2, 2, 2, 2], **kwargs)

    return model


def resnet34_sim(**kwargs):
    model = ResNet(BasicBlock, [3, 4, 6, 3], **kwargs)

    return model


def resnet50_sim(**kwargs):
    model = ResNet(Bottleneck, [3, 4, 6, 3], **kwargs)

    return model


def resnet101_sim(**kwargs):
    model = ResNet(Bottleneck, [3, 4, 23, 3], **kwargs)

    return model


def resnet152_sim(**kwargs):
